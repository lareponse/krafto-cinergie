...
<div class="card border-0 scroll-mt-3" id="signaletiqueSection">
    ...
    <div class="card-body">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg">
                <input type="text" class="form-control" id="label" name="label" value="<?= $this->e($controller->formModel()) ?>">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg">
                <input type="date" class="form-control" id="publication" name="publication" value="<?= $controller->formModel()->get('starts') ?>">
                <div class="invalid-feedback">Please add your full name</div>
            </div>

            <div class="col-lg">
                <input type="date" class="form-control" id="publication" name="publication" value="<?= $controller->formModel()->get('stops') ?>">
                <div class="invalid-feedback">Please add your full name</div>
            </div>
        </div>
