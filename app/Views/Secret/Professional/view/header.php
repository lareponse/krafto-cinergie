                ...
                <div class="row align-items-center h-100">
                    <div class="col-auto d-flex ms-auto ms-md-0">
                        <div class="avatar avatar-circle avatar-xxl">
                            <img src="<?= $controller->loadModel()->get('legacy_photo') ?>" alt="Photo de profile" class="avatar-img" width="112" height="112">
                        </div>
                    </div>

                    <div class="col-auto me-auto d-flex flex-column">
                        <h3 class="mb-0"><?= $controller->loadModel()->fullName(); ?></h3>
                    ...
                    <div class="col-12 col-md-auto ms-auto text-center mt-8 mt-md-0">
                        <div class="hstack d-inline-flex gap-6">
                            <div>
                                ...
                                <p class="text-secondary mb-0 otto-date"> <?= $controller->loadModel()->get('birth') ?? '&mdash;'; ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-secondary mb-0 otto-date"><?= $controller->loadModel()->get('death') ?? '&mdash;'; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
