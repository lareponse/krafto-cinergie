<div class="row">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <h2 class="mb-0"><?= $counters['professionals']; ?></h2>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-sm-6 col-lg-4 col-xl-3 d-flex">
        <a href="<?= $controller->router()->hyp('dash_professionals_by_segment', ['segment' => 'inactives']); ?>" class="card border-0 flex-fill w-100">
    ...
    <div class="col-sm-6 col-lg-4 col-xl-3 d-flex">
        <a href="<?= $controller->router()->hyp('dash_professionals_by_segment', ['segment' => 'unlisted']); ?>" class="card border-0 flex-fill w-100">
    ...
    <div class="col-sm-6 col-lg-4 col-xl-3 d-flex">
        <a href="<?= $controller->router()->hyp('dash_professionals_by_segment', ['segment' => 'withoutContent']); ?>" class="card border-0 flex-fill w-100">
    ...
    <div class="col-sm-6 col-lg-4 col-xl-3 d-flex">
        <a href="<?= $controller->router()->hyp('dash_professionals_by_segment', ['segment' => 'withoutProfilePicture']); ?>" class="card border-0 flex-fill w-100">
