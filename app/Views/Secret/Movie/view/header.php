                ...
                <div class="row align-items-center h-100">
                    <div class="col-auto d-flex ms-auto ms-md-0">
                        <div class="avatar avatar-circle avatar-xxl">
                            <img src="/public<?= $controller->loadModel()->get('legacy_photo') ?>" alt="..." class="avatar-img" width="112" height="112">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-auto ms-auto text-center mt-8 mt-md-0">
                        <div class="hstack d-inline-flex gap-6">
                            <div>
                                ...
                                <p class="text-secondary mb-0"> <?= $controller->loadModel()->get('released') ?? '&mdash;'; ?></p>
                            </div>
                            ...
                            <div>
                                <h4 class="h2 mb-0">
                                    <?= $this->icon('origine', 18); ?>
                                </h4>
                                <p class="text-secondary mb-0"><?= $controller->loadModel()->get('legacy_origine') ?? '&mdash;'; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
