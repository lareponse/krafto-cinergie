<header class="container-fluid d-sm-flex py-6 mb-4">

    <!-- Search -->
    <h1 class="h2"><?= $title; //$this->e($title)
                    ?></h1>
    ...
    <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
        ...
        <!-- Search Button -->
        <a class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px position-relative link-secondary" data-bs-toggle="offcanvas" href="#offcanvasSearch" role="button" aria-controls="offcanvasSearch">
        ...
        <?php $this->insert('Secret::_partials/offcanvas_notifications') ?>

        <!-- Search offcanvas -->
        <?php $this->insert('Secret::_partials/offcanvas_search') ?>
                ...
                <div class="py-4 px-5">
                    <div class="row">
                        <div class="col-4 d-flex justify-content-center align-items-center">
                            <a href="javascript: void(0);" class="d-inline-block link-secondary fs-5 fw-semibold text-center p-3">
                                <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                    <img src="/public/assets/img/tools/imdb.com.png" class="img-fluid" />
                        ...
                        <div class="col-4 d-flex justify-content-center align-items-end">
                            <a href="https://www.allocine.fr/" class="d-inline-block link-secondary fs-5 fw-semibold text-center p-3">
                                <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1 p-1">
                                    <img src="/public/assets/img/tools/allocine.fr.webp" class="img-fluid" />
                                </span>
                                AlloCiné
                            </a>
                        </div>
                        <div class="col-4 d-flex justify-content-center align-items-center">
                            <a href="javascript: void(0);" class="d-inline-block link-secondary fs-5 fw-semibold text-center p-3">
                                <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1 p-1" style="background:#FFF">
                                    <img src="/public/assets/img/tools/comedien.be.png" class="img-fluid">
                                </span>
                                Comedien.be
                            </a>
                        </div>
                        ...
                        <div class="col-4 d-flex justify-content-center align-items-center">
                            <a href="https://www.facebook.com/cinergie.be/" class="d-inline-block link-secondary fs-5 fw-semibold text-center p-3">
                                <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="<?= $controller->router()->hyp('checkout') ?>">Sign out</a>
            </div>
        </div>
    </div>
</header>