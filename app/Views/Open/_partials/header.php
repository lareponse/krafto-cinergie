<header class="navbar navbar-expand-xl  py-3" id="header">
        <div class="container">
            ...
            <div class="socials d-block d-xl-none ms-auto">
                <a type="button" data-bs-toggle="collapse" data-bs-target="#searchBAR" aria-controls="searchBAR" aria-expanded="false" aria-label="Toggle navigation" href="#" class="mx-1"><img src="./assets/img/icons/search.svg" alt=""></a>
            </div>
