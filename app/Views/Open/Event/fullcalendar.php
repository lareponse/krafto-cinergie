<div class="text-center">
    <div class="my-2" id="fullcalendar-filters">
        ...
        <button class="btn event-cat-evenement_agenda" id="event-cat-evenement_agenda">Évènements</button>
        <button class="btn event-cat-sorties" id="event-cat-sorties">Sorties</button>
        <button class="btn event-cat-seance" id="event-cat-seance">Séances</button>
    </div>
    <div id="calendar"></div>
</div>
