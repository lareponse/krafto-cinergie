(() => {
  var e,
    ...
    s = {
            ...
            (e) =>
              new Dropdown(e, {
                popperConfig: (e) => {
                  ...
                  return (
                    void 0 !== t && (t.options = { ...t.options, altAxis: !0 }),
                    e
                  );
                },
              })
          ...
          n
            ...
            .then(({ default: e }) => {
              ...
              i.forEach((t) => {
                ...
                let s = document.querySelector('[data-upload-files]'),
                  o = document.querySelector('[data-cancel-files]');
                const r = new e(t, i);
                r.on('addedfile', (e) => {
                  ...
                  s &&
                    s.addEventListener('click', (e) => {
                      e.preventDefault(), r.processQueue();
                    }),
                  o &&
                    o.addEventListener('click', (e) => {
                      e.preventDefault(), r.removeAllFiles(!0);
                    });
              }),
                (window.Dropzone = e);
            })
      ...
      9969: (e, t, n) => {
        'use strict';
        const i = document.getElementById('contestCalendar');
        i &&
          (async () => {
            ...
            let u = document.getElementById('draggable'),
              ...
              O = c().startOf('day'),
              D =
                (O.clone().subtract(1, 'day').format('YYYY-MM-DD'),
                O.format('YYYY-MM-DD'),
                O.clone().add(1, 'day').format('YYYY-MM-DD'),
                O.format('YYYY-MM'),
                null),
              L = new e(i, {
                ...
                droppable: !0,
                dayMaxEvents: !0,
                events: '/api/events/contests.json',
              });
            L.render(),
              u &&
                new a(u, {
  ...
  (r.m = s),
    ...
    (() => {
      ...
      function Z(e) {
        return 'html' === T(e)
          ? e
          : e.assignedSlot || e.parentNode || (D(e) ? e.host : null) || Y(e);
      }
      function W(e) {
        ...
        return n &&
          ...
          : n ||
              (function (e) {
                ...
                if (/Trident/i.test(j()) && O(e) && 'fixed' === H(e).position)
                  return null;
                var n = Z(e);
                for (
                  D(n) && (n = n.host);
          ...
          M =
            !0 === g
              ? (function (e) {
                  ...
                  return { x: N(t * i) / i || 0, y: N(n * i) / i || 0 };
                })({ x: _, y })
              : { x: _, y };
        return (
          (_ = M.x),
        ...
        var s =
            'clippingParents' === t
              ? (function (e) {
                  var t = he(Z(e)),
                    n =
                      ['absolute', 'fixed'].indexOf(H(e).position) >= 0 && O(e)
                        ? J(e)
                        : e;
                  return S(n)
                    ? t.filter(function (e) {
      ...
      function be(e, s) {
        ...
        var o = s,
          ...
          A = o.padding,
          k = void 0 === A ? 0 : A,
          C = U('number' != typeof k ? k : K(k, a)),
          T = y === h ? p : h,
          x = e.rects.popper,
          O = e.elements[E ? T : y],
          D = ge(S(O) ? O : O.contextElement || Y(e.elements.popper), m, _, f),
            ...
            if (d) {
              var P,
                ...
                oe = k
                  ...
                  : K + ie + ne + L.mainAxis,
                re = o.elements.arrow && J(o.elements.arrow),
                ae = re
                  ? 'y' === C
                    ? re.clientTop || 0
                    : re.clientLeft || 0
                ...
                ce = F + oe - le,
                de = V(_ ? I(Y, F + se - le - ae) : Y, F, _ ? M(Z, ce) : Z);
              (x[C] = de), (j[C] = de - F);
            }
            if (h) {
              var ue,
                ...
                we = ve ? me : fe - S[ge] - O[ge] - ye + L.altAxis,
                Ee = ve ? fe + S[ge] + O[ge] - ye - L.altAxis : _e,
                Ae =
                  _ && ve
                    ? (function (e, t, n) {
                        var i = V(e, t, n);
      ...
      var De = Oe(),
        ...
        $e = Oe({ defaultModifiers: [ie, Ae, te, L] });
      const Me = 'transitionend',
        ...
        Ke = (e, t, n = !0) => {
          ...
          let s = !1;
          const o = ({ target: n }) => {
            n === t && ((s = !0), t.removeEventListener(Me, o), Ue(e));
          };
        ...
        _initEvents() {
          this._supportPointerEvents
            ...
            : (pt.on(this._element, Lt, (e) => this._start(e)),
              pt.on(this._element, $t, (e) => this._move(e)),
      ...
      class ln extends wt {
        constructor(e, t) {
          super(e, t),
            ...
            (this._indicatorsElement = Ot.findOne(
              '.carousel-indicators',
              this._element
            )),
        ...
        _addEventListeners() {
          this._config.keyboard &&
            pt.on(this._element, Rt, (e) => this._keydown(e)),
        ...
        _addTouchEventListeners() {
          for (const e of Ot.find('.carousel-item img', this._element))
        ...
        _setActiveIndicatorElement(e) {
          ...
          const t = Ot.findOne(tn, this._indicatorsElement);
        ...
        _getItems() {
          return Ot.find(nn, this._element);
        }
        _clearInterval() {
          this._interval &&
        ...
        _directionToOrder(e) {
          return Re() ? (e === Yt ? Ft : Ht) : e === Yt ? Ht : Ft;
        }
        _orderToDirection(e) {
          return Re() ? (e === Ft ? Yt : Zt) : e === Ft ? Zt : Yt;
        }
        static jQueryInterface(e) {
          return this.each(function () {
      ...
      class En extends wt {
        ...
        _getFirstLevelChildren(e) {
          const t = Ot.find(_n, this._config.parent);
      ...
      const An = 'dropdown',
        ...
        Pn = `${jn}.${Nn}`,
        Bn = '.dropdown-menu',
        qn = Re() ? 'top-end' : 'top-start',
        zn = Re() ? 'top-start' : 'top-end',
        Hn = Re() ? 'bottom-end' : 'bottom-start',
        Fn = Re() ? 'bottom-start' : 'bottom-end',
        Yn = Re() ? 'left-start' : 'right-start',
        Zn = Re() ? 'right-start' : 'left-start',
        Wn = {
          autoClose: !0,
      ...
      class Rn extends wt {
        constructor(e, t) {
          super(e, t),
            ...
            (this._menu =
              Ot.next(this._element, Bn)[0] ||
              Ot.prev(this._element, Bn)[0] ||
              Ot.findOne(Bn, this._parent)),
        ...
        show() {
          ...
          if (!pt.trigger(this._element, Dn, e).defaultPrevented) {
            if (
              (this._createPopper(),
              'ontouchstart' in document.documentElement &&
        ...
        static dataApiKeydownHandler(e) {
          ...
          const s = this.matches(jn)
              ...
              : Ot.prev(this, jn)[0] ||
                Ot.next(this, jn)[0] ||
                Ot.findOne(jn, e.delegateTarget.parentNode),
            o = Rn.getOrCreateInstance(s);
          if (i)
            return e.stopPropagation(), o.show(), void o._selectMenuItem(e);
          o._isShown() && (e.stopPropagation(), o.hide(), s.focus());
        }
      }
      pt.on(document, Mn, jn, Rn.dataApiKeydownHandler),
        pt.on(document, Mn, Bn, Rn.dataApiKeydownHandler),
        pt.on(document, $n, Rn.clearMenus),
        pt.on(document, In, Rn.clearMenus),
        pt.on(document, $n, jn, function (e) {
      ...
      class Xn {
        ...
        _applyManipulationCallback(e, t) {
          if (Be(e)) t(e);
          else for (const n of Ot.find(e, this._element)) t(n);
        }
      }
      const Gn = 'backdrop',
        ei = 'show',
      ...
      class Ji extends wt {
        ...
        hide() {
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove($i, Ii),
                this._element.removeAttribute('aria-modal'),
                this._element.removeAttribute('role'),
      ...
      pt.on(document, Fi, '[data-bs-toggle="offcanvas"]', function (e) {
        ...
        const n = Ot.findOne(Ni);
        n && n !== t && Ji.getInstance(n).hide();
        Ji.getOrCreateInstance(t).toggle(this);
      }),
        pt.on(window, Li, () => {
          for (const e of Ot.find(Ni)) Ji.getOrCreateInstance(e).show();
        }),
        pt.on(window, Hi, () => {
          for (const e of Ot.find(
            '[aria-modal][class*=show][class*=offcanvas-]'
          ))
            'fixed' !== getComputedStyle(e).position &&
              Ji.getOrCreateInstance(e).hide();
        }),
        Et(Ji),
        Ve(Ji);
      const Ri = new Set([
      ...
      const ms = '.bs.scrollspy',
        ...
        ws = '[href]',
        Es = '.nav-link',
        As = `${Es}, .nav-item > ${Es}, .list-group-item`,
        ks = {
          offset: null,
      ...
      class Ts extends wt {
        ...
        _initializeTargetsAndObservables() {
          (this._targetLinks = new Map()),
            (this._observableSections = new Map());
          const e = Ot.find(ws, this._config.target);
          for (const t of e) {
        ...
        _activateParents(e) {
          if (e.classList.contains('dropdown-item'))
            ...
            for (const t of Ot.parents(e, '.nav, .list-group'))
              for (const e of Ot.prev(t, As)) e.classList.add(ys);
        }
        _clearActiveClass(e) {
          e.classList.remove(ys);
          const t = Ot.find(`${ws}.${ys}`, e);
      ...
      pt.on(window, vs, () => {
        for (const e of Ot.find('[data-bs-spy="scroll"]'))
      ...
      class Js extends wt {
        constructor(e) {
          super(e),
            ...
            this._parent &&
              ...
              pt.on(this._element, Ms, (e) => this._keydown(e)));
        }
        static get NAME() {
          return 'tab';
        }
        show() {
          ...
          pt.trigger(e, Ds, { relatedTarget: t }).defaultPrevented ||
            ...
            () => {
              'tab' === e.getAttribute('role')
                ? (e.setAttribute('aria-selected', !1),
                  ...
                  pt.trigger(e, Os, { relatedTarget: t }))
        ...
        _keydown(e) {
          ...
          n &&
            (n.focus({ preventScroll: !0 }), Js.getOrCreateInstance(n).show());
        }
        _getChildren() {
          return Ot.find(Zs, this._parent);
        }
        _getActiveElem() {
        ...
        _getInnerElement(e) {
          return e.matches(Zs) ? e : Ot.findOne(Zs, e);
        }
        _getOuterElement(e) {
      ...
      pt.on(document, $s, Ys, function (e) {
        ['A', 'AREA'].includes(this.tagName) && e.preventDefault(),
          He(this) || Js.getOrCreateInstance(this).show();
      }),
        pt.on(window, Is, () => {
          for (const e of Ot.find(Ws)) Js.getOrCreateInstance(e);
        }),
        Ve(Js);
      const Rs = '.bs.toast',
        Vs = `mouseover${Rs}`,
      ...
      Eo &&
        r
          ...
          .catch(console.warn);
      const Ao = document.getElementById('currentBalanceChart');
      Ao &&
        r
          .e(427)
          .then(r.bind(r, 6329))
          ...
          .catch(console.warn);
      const ko = document.getElementById('profileCompletionChart');
      ko &&
        r
          .e(427)
          .then(r.bind(r, 6329))
      ...
      So &&
        r
          ...
          .catch(console.warn);
      const Oo = document.getElementById('emailActivityChart');
      Oo &&
        Promise.all([r.e(427).then(r.bind(r, 6329))])
          ...
          .catch(console.warn);
      const Do = document.getElementById('revenueChart');
      Do &&
        r
          .e(427)
          .then(r.bind(r, 6329))
