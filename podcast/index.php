...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://cinergie.lareponse.be/css/base.css" />
  <link rel="stylesheet" type="text/css" href="https://cinergie.lareponse.be/css/glaneuses.css" />
  <link rel="stylesheet" id="font-awesome-5-all-css" href="https://cinergie.lareponse.be/css/fontawesome/css/all.min.css" type="text/css" media="all">

  <script>document.documentElement.className="js";var supportsCssVars=function(){var e,t=document.createElement("style");return t.innerHTML="root: { --tmp-var: bold; }",document.head.appendChild(t),e=!!(window.CSS&&window.CSS.supports&&window.CSS.supports("font-weight","var(--tmp-var)")),t.parentNode.removeChild(t),e};supportsCssVars()||alert("Please view this demo in a modern browser that supports CSS Variables.");</script>
  <script src="https://cinergie.lareponse.be/js/imagesloaded.pkgd.min.js"></script>
  <script src="https://cinergie.lareponse.be/js/masonry.pkgd.min.js"></script>
  <script src="https://cinergie.lareponse.be/js/charming.min.js"></script>
  <script src="https://cinergie.lareponse.be/js/tweenmax.min.js"></script>
</head>
<body>
<svg class="hidden">
...
<div class="frame">
  <header class="codrops-header">
    <div class="codrops-links">
      <a class="codrops-icon codrops-icon--drop" href="https://twitter.com/Cinergie" title="Retrouvez-nous sur Twitter"><img src="https://cinergie.lareponse.be/twitter.png" class="icon" /></a>
      <a class="codrops-icon " href="https://www.facebook.com/cinergie.be" title="Retrouvez-nous sur Facebook"><img src="https://cinergie.lareponse.be/facebook.png" class="icon" /></a>
      <a class="codrops-icon " href="https://www.instagram.com/cinergie.be" target="_blank"><img src="https://cinergie.lareponse.be/instagram.png" width="28" /> </a>
      <a class="codrops-icon " href="https://www.youtube.com/channel/UCyKdwOw0TYnSUL_vZ1BJ7jA" target="_blank"><img src="https://cinergie.lareponse.be/youtube.png" width="28"/> </a>
    </div>
  </header>
  <div class="title">
    <h3 class="title__name"><a href="https://cinergie.be"><img src="https://www.cinergie.be/images/logo-cinergie.png" alt="logo cinergie" width="200"/></a></h3>
...
<div class="grid-wrap">
  <div class="grid">
    ...
    foreach($episodes as $s_e => $e_data){
      echo '<a href="https://www.cinergie.be/podcast/play/index.php?s='.$s_e.'" class="grid__item">
        <div class="grid__item-bg"></div>
        <div class="grid__item-wrap">
          <img class="grid__item-img" src="https://cinergie.lareponse.be/play/'.$s_e.'/index.jpeg" alt="Portrait de '.$e_data['name'].'" />
        </div>
...
<script src="https://cinergie.lareponse.be/js/demo.js"></script>
