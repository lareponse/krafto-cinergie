<?php
return [
  'name' => 'Rosine Mbakam', 'code' => '',

  'youtube' => 'Sgf9YTvydPY',

  'ausha_player' => '<iframe frameborder="0" loading="lazy" id="ausha-Nso9" height="220" style="border: none; width:100%; height:220px" src="https://player.ausha.co/index.html?showId=oRR8aix947Xp&color=%2372238e&podcastId=BxEkGtkaM6Qq&v=3&playerId=ausha-Nso9"></iframe>',

  'cinergie' => 'https://www.cinergie.be/personne/mbakam-rosine',
  ...
  'related' => [
    ...
    [
      ...
      'links' => [
        ...
        'L\'entrevue' => 'https://www.cinergie.be/actualites/rosine-mbakam-a-propos-des-prieres-de-delphine'
      ]
    ],
  ]
];
